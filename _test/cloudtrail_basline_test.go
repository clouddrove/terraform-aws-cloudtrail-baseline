...
// Description : This Terratest is used to test the Terraform cloudtrail baseline  module.
...
func Test(t *testing.T) {
	...
	Arn := terraform.Output(t, terraformOptions, "cloudtrail_arn")

	// Check that we get back the outputs that we expect
	assert.Contains(t, Arn, "arn:aws:cloudtrail")
}
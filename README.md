...
<a href="https://github.com/clouddrove//terraform-aws-cloudtrail-baseline/releases/latest">
  <img src="https://img.shields.io/github/release/clouddrove//terraform-aws-cloudtrail-baseline.svg" alt="Latest Release">
</a>
<a href="https://github.com/clouddrove//terraform-aws-cloudtrail-baseline/actions/workflows/tfsec.yml">
  <img src="https://github.com/clouddrove//terraform-aws-cloudtrail-baseline/actions/workflows/tfsec.yml/badge.svg" alt="tfsec">
</a>
<a href="LICENSE.md">
...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/clouddrove/terraform-aws-cloudtrail-baseline/releases).
...
This module has dependencies on:
- [Labels module](https://github.com/clouddrove/terraform-aws-labels): Provides resource tagging.
- [S3 bucket module](git::https://github.com/clouddrove/terraform-aws-s3.git?ref=tags/2.0.0): Provides resource tagging.
- [kms-key module](git::https://github.com/clouddrove/terraform-aws-kms.git?ref=tags/1.3.1): Provides resource tagging.
- [cloudtrial module](https://github.com/clouddrove/terraform-aws-cloudtrail-baseline): Provides resource tagging.
- [cloudtrail-slack-notification module](https://github.com/clouddrove/terraform-aws-cloudtrail-slack-notification): Provides resource tagging.
...
<a href="https://github.com/clouddrove/terraform-aws-cloudtrail-baseline/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=clouddrove/terraform-aws-cloudtrail-baseline&max" />
</a>
<br>
<br>
...
## Feedback 
Spot a bug or have thoughts to share with us? Let's squash it together! Log it in our [issue tracker](https://github.com/clouddrove/terraform-aws-cloudtrail-baseline/issues), feel free to drop us an email at [hello@clouddrove.com](mailto:hello@clouddrove.com).

Show some love with a ★ on [our GitHub](https://github.com/clouddrove/terraform-aws-cloudtrail-baseline)!  if our work has brightened your day! – your feedback fuels our journey!

...
module "s3_log_bucket" {
  ...
  source = "git::https://github.com/clouddrove/terraform-aws-s3.git?ref=tags/v2.0.2"
...
module "kms_key" {
  source = "git::https://github.com/clouddrove/terraform-aws-kms.git?ref=tags/v1.3.4"
